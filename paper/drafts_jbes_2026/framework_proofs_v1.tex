...
orthogonal to $(L,x)$. The concept-erasure diagnostic probes for this orthogonal
variation by recovering location from the embedding and driving its recoverable share
to the floor, rather than estimating $\mathbb{E}[\tilde T^{2}]$ directly. Writing
$R^2_{T\sim(L,x)}=1-\mathbb{E}[\tilde
