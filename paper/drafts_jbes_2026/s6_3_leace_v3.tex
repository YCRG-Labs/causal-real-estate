...
erasing the lat-lon concept from the representation, and we report where the erasure
...
\citet{iskander2023shielded} is aimed at exactly that residual, alternating between fitting
