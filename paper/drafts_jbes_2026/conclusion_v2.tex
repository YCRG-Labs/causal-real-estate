...
adjustment, the renter share of housing stock is identified under primary-outcome testing (motivated by the housing-search information-frictions literature of \citet{stigler1961economics}, \citet{genesove1997equity}, and \citet{anenberg2020housing}) as the operative moderator of the Shen-Ross uniqueness premium, with Hartung-Knapp coefficient $+0.025$ per standard deviation of renter share ($p = 0.009$ at $\alpha = 0.05$ without multiple-testing adjustment under the primary-endpoint convention of \citet{westfall2001optimally}); secondary scans across seven additional ACS demographic variables return no further moderator that survives Benjamini-Hochberg false-discovery control. Markets with high renter shares carry stronger
