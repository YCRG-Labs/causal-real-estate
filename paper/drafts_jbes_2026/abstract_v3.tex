% Abstract, AOAS-targeted, written to the academic-prose standard (no em dashes,
% no first/second scaffolding, flowing varied sentences, narrative that traces
% the argument). Corrected thesis: the text-price effect is ROBUST to spatial
% deconfounding (mostly genuine semantic content), not laundered geography, with
% New York the partial exception; plus the embedding-treatment coverage result.
% Numbers locked: erasure R^2 up to 0.5 -> ~0; confounded share <5% in 11/12;
% Shen +0.072 / Baur +0.156, near-collinear; no surviving moderator; IF-SE
% undercoverage + bootstrap remedy.
\begin{abstract}
