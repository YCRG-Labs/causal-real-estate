...
Within each market the listings form a near-epoch-dependent random field on geographic
distance satisfying the conditions of \citet{jenish2009central}, and the cross-fitted
nuisances satisfy the rates of \citet{chernozhukov2018double}.
\end{assumption}
...
panel reports once they are widened to the spatial-HAC scale of
