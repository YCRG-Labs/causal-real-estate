...
% ======================================================================
% NOTE — decomposition (headline) figure PENDING DATA.
% The Gelbach-style "confounded geography share vs residual semantic share" per
% market requires a pre/post-LEACE PRICE re-estimate (run the Baur DML on the
% lat-lon-erased embedding and compare to the un-erased estimate). LEACE is
% currently used only as a representation diagnostic (Fig fig:erasure-12), not on
% the price estimand, so that estimate does not yet exist. Build this figure once
% data/scripts/replications/baur_pooled_pca.py is run on the erased embeddings.
% ======================================================================
