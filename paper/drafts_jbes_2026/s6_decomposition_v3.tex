...
The location-adjusted estimate moves by at most $0.030$ of a log point across the
twelve markets, in New York, and by under $0.02$ in every other market, with no
market changing sign and the pooled effect shifting from $+0.144$ to $+0.137$, so
that a basis flexible enough to absorb twice the geography leaves the semantic
estimate essentially where the quadratic left it. The finer spatial grain the
