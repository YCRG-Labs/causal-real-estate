% §6.1 Shen-Ross Doc2Vec uniqueness channel, 12-city panel.
% Numbers locked against results/replications/shen_12city_table.csv.
% Flowing prose, no em dashes, no enumerations.
...
corpus contains 285 to 334 listings per market, and the power
calculation in the rightmost column of Table~\ref{tab:shen-12city}
shows that against Shen's published Atlanta point estimate of
approximately $+0.05$ per $\sigma$ our per-city panel has power around
$6.7\%$, well below the minimum-detectable-effect threshold of any
conventional power calculation. Under this reading the absence of
significance in ten cities is not evidence against a true Shen-Ross
effect, only evidence that our panel does not have the sample size
to detect one.

The second reading attributes the cross-city heterogeneity to genuine
between-market variation in the operative residual axis. Section
\ref{sec:meta-regression-12} addresses this directly with a
mixed-effects meta-regression that adjusts for within-city sampling
variance and asks whether covariates of the metropolitan market
structure can explain the dispersion of our twelve per-market
estimates. The single moderator that survives the Knapp-Hartung
small-sample adjustment is the renter share of the housing stock,
with coefficient $+0.026$ per percentage point of renter share at
$p = 0.008$ and a Benjamini-Hochberg false-discovery $q$-value of
$0.067$. This is direct evidence that the Shen-Ross uniqueness effect
is stronger in markets where a larger share of housing transactions
involves prospective tenants who lack the deep neighborhood
familiarity that long-term owner-occupiers possess.
