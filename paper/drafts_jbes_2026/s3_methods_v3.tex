...
rather than the effect of a cleanly separated semantic attribute, and we are
...
sits. The dashed edge labelled $\theta$ is the direct effect of text on price, the
...
concept on the cleaned representation and confirm that it does no better than
