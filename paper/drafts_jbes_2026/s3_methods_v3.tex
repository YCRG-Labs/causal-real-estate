...
\citet{chernozhukov2018double}, using gradient boosting for the embedding-based
channels and ridge regression for the Shen-Ross uniqueness channel in keeping with
its published hedonic protocol. Each market is split into $K = 5$ folds, and each
