% Full proof of the continuous-spatial Davis-Kahan causal-bias theorem.
% Drafted 2026-05-29. Lemma 6 corrects the eigengap exponent in the original
% theorem statement: at the BBP cutoff, delta_r asymp lambda^{d/(2nu+d)},
% not lambda^{2nu/(2nu+d)}. The latter is the integrated bias scale used in
% the bias bound (iii), not the eigengap that drives sin-Theta in (ii).
% The sim should test the corrected ~0.286 slope (d=2, nu=2.5), not 0.714.
...
% Lemma statements and proofs (1 through 9) follow. See accompanying file
% dk_full_proof_lemmas.tex for the full lemma block; the abridged main proof
% chain (i)->(ii)->(iii)->(iv)->(v) is in the main paper appendix.

% Main proof: chaining (i)-(v)
