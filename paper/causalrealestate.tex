...
recorded sale prices in the four markets where transactions are public, though it
attenuates, since part of the asking-price association is the agent's own pricing
of the language. The estimates are associational, and we bound their fragility
with a sensitivity analysis. In most markets, a listing's language is priced for
...
\input{drafts_jbes_2026/s6_8_saleprice_v3}
