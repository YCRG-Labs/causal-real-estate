...
\draw[thin, gray] (axis cs:0,-3.613)   -- (axis cs:0,  2.664);
\draw[thin, gray] (axis cs:30,-3.270)  -- (axis cs:30, 2.804);
\draw[thin, gray] (axis cs:32,-1.179)  -- (axis cs:32, 0.972);
\draw[thin, gray] (axis cs:43,-0.824)  -- (axis cs:43, 0.834);
\draw[thin, gray] (axis cs:47,-0.750)  -- (axis cs:47, 0.866);
\draw[thin, gray] (axis cs:55,-0.721)  -- (axis cs:55, 0.789);
\draw[thin, gray] (axis cs:61,-0.646)  -- (axis cs:61, 0.836);
...
\end{axis}
\end{tikzpicture}
\caption{Confounder escalation for New York. The horizontal axis is the cumulative dimensionality of the adjustment set, beginning at zero with no controls and rising through the seven canonical blocks to a full sixty-one-feature specification at the right edge. The vertical axis is the binarized doubly-robust ATE on log price for the leading sentence-BERT principal component, and the dashed horizontal line marks the null. Filled circles are point estimates and the thin gray segments are ninety-five percent bootstrap confidence intervals at $B = 500$ resamples. The coordinate block at $d = 32$ does almost all of the magnitude-shrinkage work, taking the point estimate from $-0.228$ to $-0.038$ and shrinking the confidence band by roughly a factor of three. The monotone-shrinkage pattern is the Cinelli--Hazlett signature of confounding bias being removed as the spatial adjustment set is enriched.}
