...
\begin{table}[!htbp]
\centering
\caption{Sensitivity of binarized doubly-robust ATE estimates to price outlier thresholds for San Francisco, the city for which the description sample retains $N = 348$ across all three windows. Confidence intervals are influence-function based. Identical estimates across thresholds reflect the small number of price outliers in the description sample.}
\label{tab:sensitivity_results}
\begin{tabular}{lrrr}
\toprule
\textbf{Thresholds} & \textbf{N} & $\hat{\tau}_{\text{causal}}$ & \textbf{95\% IF CI} \\
\midrule
\$25K -- \$25M & 348 & $-0.0843$ & [$-0.120$, $-0.049$] \\
\$50K -- \$20M & 348 & $-0.0843$ & [$-0.120$, $-0.049$] \\
\$75K -- \$15M & 348 & $-0.0843$ & [$-0.120$, $-0.049$] \\
\bottomrule
\end{tabular}
\end{table}
\FloatBarrier
