...
it near seven percent per standard deviation. The effect survives holding the
...
in the panel, its naive effect a null, and every design that removes location
recovers a significant premium there. The surviving premium is modest, but it is
