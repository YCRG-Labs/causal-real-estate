...
Theorem~1 (Backdoor Identifiability, App.~\ref{app:proofs}) & Independent identification on the hypothetical $T \to Y$ DAG; backdoor estimand returned & DoWhy 0.14 \\
Corollary~1 (Zero Effect under True SCM, App.~\ref{app:proofs}) & Edge-set check ($T \notin \mathrm{Pa}(Y)$); DoWhy declares zero & pgmpy + DoWhy \\
