...
\begin{abstract}
Automated valuation models increasingly price homes by reading the prose of a
listing alongside its structured attributes, and the language reliably improves
their predictions. Whether that improvement reflects information about the property
or merely the neighborhood an agent's description encodes has not been tested, and
